<?php
	...
	if(($result->account==$_Account && $result->password == $_Hash && $result->is_admin == 1) || ($_SESSION['Identity'] == 2))
		{	
	...
	else if(($result->account==$_Account && $result->password == $_Hash && $result->is_admin == 0) || ($_SESSION['Identity'] == 1))
		{
			$_SESSION['Identity'] = 1;
			$_SESSION['Account'] = $_Account;
			$_SESSION['ID'] = $result->ID;
